...
public final class GLTextureUtils {
    ...
    /** Load texture with GL_NEAREST min filter (prevents black edge bleeding on PNGs). */
    public static int loadTextureNearestMin(Context context, String assetPath) {
        return loadTextureEx(context, assetPath, false, true, false, false);
    }
