...
public class WallpaperSettings {
    ...
    public static final String KEY_FALL_SWIPE_RIPPLE = "pref_fall_swipe_ripple";
    public static final String KEY_FALL_DAY_NIGHT = "pref_fall_day_night";
    public static final String KEY_FALL_GLOW = "pref_fall_glow";
    ...
    public static final String KEY_GRASS_LIGHT = "pref_grass_light";
    public static final String KEY_GRASS_GLOW = "pref_grass_glow";
    ...
    public static boolean isFallSwipeRippleEnabled(boolean defValue) {
        SharedPreferences p = prefs();
        if (p == null) return defValue;
        return p.getBoolean(KEY_FALL_SWIPE_RIPPLE, defValue);
    }

    public static boolean isFallDayNightEnabled(boolean defValue) {
        SharedPreferences p = prefs();
        if (p == null) return defValue;
        return p.getBoolean(KEY_FALL_DAY_NIGHT, defValue);
    }

    public static boolean isFallGlowEnabled(boolean defValue) {
        SharedPreferences p = prefs();
        if (p == null) return defValue;
        return p.getBoolean(KEY_FALL_GLOW, defValue);
    }
     ...
     * 草叶逆光（晨昏的透光与迎光边）。
     *
     * <p>默认关 —— 项目原则是默认还原 AOSP，美学增强一律做成可关的开关。
     */
    public static boolean isGrassLightEnabled(boolean defValue) {
        SharedPreferences p = prefs();
        if (p == null) return defValue;
        return p.getBoolean(KEY_GRASS_LIGHT, defValue);
    }
     ...
     * <p>默认关 —— 项目原则是默认还原 AOSP，美学增强一律做成可关的开关。
     */
    public static boolean isGrassGlowEnabled(boolean defValue) {
        SharedPreferences p = prefs();
        if (p == null) return defValue;
        return p.getBoolean(KEY_GRASS_GLOW, defValue);
    }
