...
public class WindmillGL extends GLESScene {
    ...
    private void loadTextures() {
        ...
        for (int i = 0; i < 25; i++) {
            mRaindrop1[i] = GLTextureUtils.loadTextureFromAsset(mContext, "weatherwallpapers/common/drawable/waterdrop_a_" + i + ".png");
            mRaindrop2[i] = GLTextureUtils.loadTextureFromAsset(mContext, "weatherwallpapers/common/drawable/waterdrop_b_" + i + ".png");
        }
    }
