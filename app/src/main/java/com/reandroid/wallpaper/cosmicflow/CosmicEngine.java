...
public class CosmicEngine extends BasePluginEngine {

    public CosmicEngine(Context context, WallpaperPluginHost host) {
        super(context, host);
    }

    @Override
    protected GLESScene createScene(int width, int height, Context context) {
        return new CosmicGL(width, height, context);
    }
}
